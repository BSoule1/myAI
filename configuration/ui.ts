...
export const CHAT_HEADER: string = `Mackenzie.AI`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Have a nice day`;
export const CLEAR_BUTTON_TEXT: string = `Restart Chat`;
export const PAGE_TITLE: string = `Mackenzie.AI`;
